...
.apm-standalone-head{display:flex;align-items:center;gap:8px;color:var(--dsw-alias-label-primary)}
.apm-standalone-title{font-weight:600;flex:1}
.apm-standalone-details{padding:0 0 0 22px}
...
@media (max-width:640px){.apm-form{flex-wrap:wrap}.apm-form .apm-input{flex-basis:100%}.apm-plugin-topline{align-items:flex-start}.apm-plugin-actions{flex-wrap:wrap;justify-content:flex-end}.apm-plugin-summary{display:none}.apm-plugin-details,.apm-standalone-details{padding-left:0}}`))
      ...
      function MarketPage() {
        ...
        for (const item of catalog) {
          ...
          const visibleStandaloneSkills = item.visibleStandaloneSkills.slice(0, standaloneLimit)
          ...
          if (visibleStandaloneSkills.length > 0) {
            ...
            card.push(React.createElement('section', { className: 'apm-standalone', key: 'standalone-skills', 'aria-label': '独立技能（skills/）' },
              React.createElement('div', { className: 'apm-standalone-head' },
                React.createElement(UI.IconSkillOutline16, { size: 16 }),
                React.createElement('span', { className: 'apm-standalone-title' }, '独立技能（skills/）'),
                React.createElement(Btn, {
                  disabled: busy !== null,
          ...
          if (item.visibleStandaloneSkills.length > visibleStandaloneSkills.length || visibleStandaloneSkills.length > CATALOG_PAGE_SIZE) {
            card.push(React.createElement('div', { className: 'apm-catalog-more', key: 'standalone-more' },
