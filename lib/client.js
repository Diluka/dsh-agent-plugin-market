...
.apm-name{font-weight:600;flex:0 1 160px;min-width:0;max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.apm-repo{color:var(--dsw-alias-label-secondary);font-size:12px;flex:1 1 96px;min-width:0;max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.apm-tag{flex:none}
