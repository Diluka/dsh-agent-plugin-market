...
@media (max-width:640px){.apm-form{flex-wrap:wrap}.apm-form .apm-input{flex-basis:100%}.apm-plugin-topline{align-items:flex-start}.apm-plugin-actions{flex-wrap:wrap;justify-content:flex-end}.apm-plugin-summary{display:none}.apm-plugin-details,.apm-standalone-details{padding-left:0}}`))
      ...
      function MarketPage() {
        ...
        children.push(React.createElement('div', { className: 'apm-hint', key: 'hint' },
          '将 git 仓库作为 agent 插件市场或独立技能仓库：添加后克隆到 .dsh/agent-plugin-market，插件及未被引用的根 skills/ 技能均可加载（兼容 Codex / Claude / Copilot 的 SKILL.md 格式）。DSH 启动时自动更新各市场。'))
        ...
        for (const item of catalog) {
          ...
          if (item.visibleStandaloneSkills.length > 0) {
            ...
            for (const skill of item.visibleStandaloneSkills) {
