...
dshWindow.__ModuleLoader__.load({
  ...
  factory: (/** @type {(id: string) => any} */ require) => {
     ...
     * @typedef {{available?: boolean, found?: boolean, active?: boolean, enabled?: boolean, error?: string, needsApproval?: boolean, count?: number}} CatalogHooks
     * @typedef {{name: string, title?: string, description?: string, error?: string, sourceType?: string, installed?: boolean, unsupported?: boolean, skills?: CatalogSkill[], hooks?: CatalogHooks | null}} CatalogPlugin
