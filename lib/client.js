...
@media (max-width:640px){.apm-root{min-width:0;overflow-wrap:anywhere}.apm-form{flex-wrap:wrap}.apm-form .apm-input{flex-basis:100%}.apm-scope{align-items:stretch}.apm-scope-label,.apm-scope-note{width:100%}.apm-scope-mode{min-width:0;max-width:100%;white-space:normal}.apm-card{padding:12px;overflow:hidden}.apm-card-head,.apm-plugin-topline{align-items:flex-start;flex-wrap:wrap}.apm-market-actions,.apm-plugin-actions{width:100%;flex-wrap:wrap;justify-content:flex-start;margin-left:0}.apm-plugin-summary{display:none}.apm-plugin-details,.apm-standalone-details{padding-left:0}.apm-skill{flex-wrap:wrap}.apm-skill-state{white-space:normal}}`))
