...
export const HOOKS_BRIDGE_INSTALL_COMMAND = 'pnpm --dir "$DSH_PROFILE_DIR" add @deepseek-ai/dsh-hooks-codex@0.1.7-rc.1 @deepseek-ai/dsh-hook-protocol@0.1.7-rc.1'
const HOOKS_BRIDGE_UNAVAILABLE_ERROR = 'Codex hooks bridge 不可用；请先在目标 profile 中安装依赖：' + HOOKS_BRIDGE_INSTALL_COMMAND + '，然后重启 DSH'
