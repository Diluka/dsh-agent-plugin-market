...
/**
 * @typedef {ReturnType<typeof import('./market-runtime.js').createMarketRuntime>} MarketRuntime
 * @typedef {ReturnType<typeof import('./codex-hook-manager.js').createCodexHookManager>} CodexHookManager
 * @typedef {{repo: string, refType?: 'default' | 'branch' | 'tag' | 'commit', ref?: string}} AddMarketArgs
 * @typedef {{marketId: string}} MarketIdArgs
 * @typedef {{marketId: string, pluginName: string}} PluginArgs
 * @typedef {{fullName: string, enabled: boolean, standalone?: boolean}} SetSkillEnabledArgs
 * @typedef {{marketId: string, enabled: boolean}} SetStandaloneSkillsEnabledArgs
 * @typedef {{marketId: string, pluginName: string, enabled: boolean}} SetPluginHooksEnabledArgs
 * @typedef {{name: string, fullName: string, description: string, whenToUse: string | null, enabled: boolean}} MarketSkillView
 * @typedef {{available: boolean, found: boolean, count: number, enabled: boolean, active: boolean, needsApproval: boolean, error: string | null}} MarketHookView
 * @typedef {{name: string, installed: boolean, unsupported: boolean, sourceType: string, title: string, description: string, error: string | null, skills: MarketSkillView[], hooks: MarketHookView | null}} MarketPluginView
 * @typedef {{id: string, name: string, repo: string, description: string, refType: string, ref: string | null, manifestFound: boolean, standaloneSkills: MarketSkillView[], plugins: MarketPluginView[]}} MarketView
 * @typedef {{hooksBridge: {available: boolean, installCommand: string}, markets: MarketView[]}} MarketState
 * @typedef {object} MarketService
 * @property {(args: AddMarketArgs) => Promise<{id: string, name: string, repo: string, refType: string, ref: string | null}>} addMarket
 * @property {(args: MarketIdArgs) => Promise<{updated: boolean} | {skipped: boolean, reason: string}>} updateMarket
 * @property {(args: MarketIdArgs) => Promise<{removed: boolean}>} removeMarket
 * @property {(args: PluginArgs) => Promise<{installed: boolean}>} installPlugin
 * @property {(args: PluginArgs) => Promise<{removed: boolean}>} uninstallPlugin
 * @property {(args: SetSkillEnabledArgs) => Promise<{fullName: string, enabled: boolean}>} setSkillEnabled
 * @property {(args: SetStandaloneSkillsEnabledArgs) => Promise<{marketId: string, enabled: boolean, count: number}>} setStandaloneSkillsEnabled
 * @property {(args: SetPluginHooksEnabledArgs) => Promise<{key: string, enabled: boolean, active: boolean, error?: string | null}>} setPluginHooksEnabled
 * @property {() => Promise<MarketState>} getState
 * @property {(ctx: import('@deepseek-ai/cordis').Context) => void} registerAutoUpdate
 */
...
/**
 * Creates the Host service that orchestrates market and Hook state changes.
 *
 * @param {{runtime: MarketRuntime, hooks: CodexHookManager, onSkillsChanged: () => void}} options
