...
import { registerMarketTools, workspacePathForCwd } from './market-tools.js'

// Connection registers custom RPC channels on the caller Fiber's webServer.
/** @type {readonly ['skills', 'fs', 'settings', 'subprocess', 'connection', 'webServer', 'tools']} */
export const inject = ['skills', 'fs', 'settings', 'subprocess', 'connection', 'webServer', 'tools']
...
export async function apply(ctx) {
  ...
  registerMarketTools(ctx, { service, runtime, workspaces })
