 ...
 * @typedef {{version: 1, plugins: Record<string, boolean>, pluginSkills: Record<string, boolean>, standaloneSkills: Record<string, boolean>}} WorkspaceConfig
 */
 ...
 * @param {'plugins' | 'pluginSkills' | 'standaloneSkills'} group
 * @param {string} key
 ...
 * @param {'plugins' | 'pluginSkills' | 'standaloneSkills'} group
 * @param {string} key
 * @param {'inherit' | 'enabled' | 'disabled'} mode
 */
